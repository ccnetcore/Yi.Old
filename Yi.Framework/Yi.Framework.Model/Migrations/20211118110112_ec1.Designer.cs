            ...
            modelBuilder.Entity("Yi.Framework.Model.Models.spu", b =>
                {
                    ...
                    b.Property<int?>("cid1id")
                        .HasColumnType("int");

                    b.Property<int?>("cid2id")
                        .HasColumnType("int");

                    b.Property<int?>("cid3id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Yi.Framework.Model.Models.spu", b =>
                {
                    ...
                    b.HasOne("Yi.Framework.Model.Models.category", "cid1")
                        .WithMany()
                        .HasForeignKey("cid1id");

                    b.HasOne("Yi.Framework.Model.Models.category", "cid2")
                        .WithMany()
                        .HasForeignKey("cid2id");

                    b.HasOne("Yi.Framework.Model.Models.category", "cid3")
                        .WithMany()
                        .HasForeignKey("cid3id");
